        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-300">
              Connecting cannabis consumers with the best dispensaries and doctors in {domain.state}.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={getLink('/')} className="text-gray-300 hover:text-accent transition duration-300">
                  Home
                </Link>
              </li>
              <li>
                <Link to={getLink('/dispensaries')} className="text-gray-300 hover:text-accent transition duration-300">
                  Dispensaries
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-accent text-dark"
                required
              />
              <button
                type="submit"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link to={getLink('/privacy')} className="text-gray-400 hover:text-accent transition duration-300">
                Privacy Policy
              </Link>
              <Link to={getLink('/terms')} className="text-gray-400 hover:text-accent transition duration-300">
                Terms of Service
              </Link>
              <Link to={getLink('/accessibility')} className="text-gray-400 hover:text-accent transition duration-300">
                Accessibility
              </Link>
            </div>
          </div>
