...
export function ContactPage() {
  ...
  // This would be handled by a form action in a real implementation
            ...
            {formSubmitted ? (
              ...
              <>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h3 className="text-sm font-medium text-primary">Business Hours</h3>
                          <p className="text-gray-700">
                ...
                <div className="border-t border-gray-200 pt-6">
                  <h2 className="text-xl font-bold text-primary mb-4">Follow Us</h2>
                  <div className="flex space-x-4">
                    <a href="#" className="text-secondary hover:text-accent transition duration-300">
